          ...
          <div className="productCard-options">
            <li onClick={() => setAppear(!appear)}>
              {appear ? (
                ...
                <Icon name={"Ban"} color={styles.primaryColorLight} />
              )}
            </li>
            <li onClick={() => setExist(!exist)}>
              {exist ? (
                <Icon name={"Store"} color={styles.primaryColorLight} />
              ) : (
                <Icon name={"StoreS"} color={styles.primaryColorLight} />
              )}
            </li>
            <li>
              <Icon name={"Edit"} color={styles.secondaryColor} />
            </li>
          </div>
        </div>
